...
with col1:
    opening_price = st.number_input("Enter the Opening Price:", min_value=0.0, format="%.6f")
with col2:
    closing_price = st.number_input("Enter the Closing Price:", min_value=0.0, format="%.6f")
